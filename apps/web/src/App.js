...
function App() {
    ...
    const handleCreateEpic = (projectId) => async (event) => {
        ...
        try {
            ...
            // Using endpoint-specific payload
            const epicPayload = {
                name,
